...
router.post('/', function(req, res, next){
	...
	var addProduct="INSERT into products(name,description,price,quantity,sellerInfo,type) values ('" + req.param("name") + "','" + req.param("description") + "','" + req.param("price") + "','" + req.param("quantity") + "','" + req.session.username +"','new')";
